...
parallel_data = data_dir . "/temp_file_ten_runs_parallel_data_" \
   . run_number . ".txt"
parallel_contours = data_dir . "/" . "ten_runs_parallel_" \
  . run_number . "_contours.dat"

perpendicular_data = data_dir . "/temp_file_ten_runs_perpendicular_data_" \
   . run_number . ".txt"
perpendicular_contours = data_dir . "/" . "ten_runs_perpendicular_" \
  . run_number . "_contours.dat"

diagonal_data = data_dir . "/temp_file_ten_runs_diagonal_data_" \
   . run_number . ".txt"
diagonal_contours = data_dir . "/" . "ten_runs_diagonal_" \
  . run_number . "_contours.dat"
